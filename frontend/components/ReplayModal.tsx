        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
          <div>
            ...
            <p style={{ fontSize: 12, color: "var(--text-muted)", marginTop: 4, maxWidth: 480 }}>
              You play {userColorWord.toLowerCase()} from here. {opponentName} is played by an AI calibrated
              to their actual rating{opponentRating ? ` (${opponentRating})` : ""}
              {hasFingerprint ? " and the mistakes they actually made in this game" : ""} — not a raw chess engine.
            </p>
          </div>
          <button
            onClick={onClose}
